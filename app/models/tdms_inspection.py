...
class TDMSInspection(Base):
    __tablename__ = "tdms_inspection"
    __table_args__ = (
        Index("ix_tdms_inspection_asset_id", "asset_id"),
        Index("ix_tdms_inspection_inspection_date", "inspection_date"),
        Index("ix_tdms_inspection_asset_inspection_date", "asset_id", "inspection_date"),
    )
    ...
    asset = relationship("AssetMaster", back_populates="tdms_inspections")
